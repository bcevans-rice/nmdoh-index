<template>
  <HeaderTitle title="Indexed Abstracts" />
              ...
              <table class="min-w-full divide-y divide-gray-300">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                  <tr v-for="abs in newAbstracts" :key="abs.responseID">
                    <td class="max-w-sm truncate py-4 pl-4 pr-3 text-sm font-bold text-gray-900 sm:pl-6">
...
const response = await fetch('https://kllxvfjrmlaj2ywwdfjux3ebeu0wizyp.lambda-url.us-west-2.on.aws/', {cors: true});
